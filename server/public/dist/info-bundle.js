...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_demo_vue__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_054b9c73_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_demo_vue__ = __webpack_require__(43);
var disposed = false
...
var contentApp = new _vue2.default({
    el: '#contentApp',
    data: {
    ...
    methods: {
        getData: function getData() {
            this.$axios.get('/users/queryAll').then(function (res) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(45)("4476282e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
